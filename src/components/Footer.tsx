      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#home" className="text-xl font-bold">
              Chaithanya<span className="text-purple-400">.dev</span>
            </a>
            <p className="mt-2 text-gray-400 max-w-md">
              Cybersecurity enthusiast and web developer creating secure and creative digital solutions.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p className="flex items-center justify-center">
            Made with <Heart size={16} className="mx-1 text-red-500" /> by Chaithanya Lakshmi Rachapudi
          </p>
          <p className="mt-2">
